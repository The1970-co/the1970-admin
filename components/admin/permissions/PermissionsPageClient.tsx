...
const MODULE_HEALTH = [
  ...
  { module: "Mẫu mã & Vải", backend: "design_sample.* / fabric_receipt.*", status: "ready", note: "Tách quyền xem/sửa mẫu, nhận vải, GSM, đơn giá và duyệt chênh lệch." },
...
const PERMISSION_MODULES: PermissionModule[] = [
  ...
  },
  {
    ...
    tone: "indigo",
    actions: [
      { key: "menu.design_samples", label: "Mở menu Quản lý mẫu mã", risk: "low" },
      { key: "design_sample.view", label: "Xem mẫu mã", risk: "low" },
      { key: "design_sample.create", label: "Tạo mẫu", risk: "medium" },
      { key: "design_sample.edit", label: "Sửa mẫu / tiến độ / màu", risk: "high" },
      { key: "design_sample.upload_images", label: "Upload ảnh mẫu / bảng vải", risk: "medium" },
      { key: "design_sample.delete", label: "Xoá mẫu chưa phát sinh vải", risk: "critical" },
