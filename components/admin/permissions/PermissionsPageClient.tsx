...
const PERMISSION_MODULES: PermissionModule[] = [
  ...
  },
  {
    ...
    actions: [
      ...
      { key: "menu.omni_tags", label: "Mở menu Nhãn hội thoại", risk: "low", desc: "Cho phép nhìn thấy mục Nhãn hội thoại trong Omni Inbox." },
      ...
      { key: "omni_inbox.tags.manage", label: "Quản lý tag hội thoại", risk: "medium" },
