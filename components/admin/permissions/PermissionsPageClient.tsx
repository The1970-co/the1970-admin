...
const MODULE_HEALTH = [
  ...
  { module: "Mẫu mã & Vải", backend: "fabric_library.* / sample_dispatch.* / design_sample.* / fabric_receipt.*", status: "ready", note: "Đã tách thư viện, triển khai mẫu, vải về; danh tính NCC và dữ liệu giá/tỷ giá có quyền riêng." },
  ...
  },
  {
    ...
    actions: [
      ...
      { key: "fabric_receipt.upload_images", label: "Upload ảnh vải, lỗi, mẫu tròn, cân", risk: "medium" },
      {
        ...
        label: "Xem đầy đủ danh tính NCC vải",
        risk: "high",
        desc: "Không có quyền này thì app/web chỉ nên hiện mã NCC, không hiện tên, SĐT, email, địa chỉ.",
      },
      {
        key: "fabric_receipt.cost.view",
        label: "Xem đơn giá / tiền tệ / tỷ giá vải",
        risk: "critical",
        desc: "Cho phép xem đơn giá, loại tiền, tỷ giá CNY→VND và giá quy đổi.",
      },
      {
        key: "fabric_receipt.cost.edit",
        label: "Sửa đơn giá / tiền tệ / tỷ giá vải",
        risk: "critical",
        desc: "Cho phép nhập và chỉnh đơn giá, tiền tệ, tỷ giá và dữ liệu quy đổi.",
      },
  ...
  },
  {
    ...
    actions: [
      ...
      { key: "accessories.view", label: "Xem nguyên phụ liệu", risk: "low" },
      {
        ...
        label: "Xem đơn giá NPL",
        risk: "critical",
        desc: "Không có quyền này thì backend và giao diện không trả/hiện đơn giá nguyên phụ liệu.",
      },
      {
        key: "accessories.supplier_identity.view",
        label: "Xem đầy đủ danh tính NCC NPL",
        risk: "high",
        desc: "Không có quyền này thì chỉ hiện mã NCC, không hiện tên và thông tin liên hệ.",
      },
