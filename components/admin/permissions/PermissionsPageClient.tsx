...
const MODULE_HEALTH = [
  ...
  { module: "Sản xuất & Nguyên liệu", backend: "fabric_library.* / design_sample.* / measurement_library.* / fabric_receipt.* / production.* / accessories.*", status: "ready", note: "Web có đủ 6 màn như app; Vải về và NPL tách quyền dữ liệu nhạy cảm chi tiết." },
...
const PERMISSION_MODULES: PermissionModule[] = [
  ...
  {
    id: "production",
    title: "Sản xuất & Nguyên liệu",
    subtitle: "Phân quyền web cho 6 màn: Bảng vải, Triển khai mẫu, Bảng thông số, Vải về, Sản xuất và Nguyên phụ liệu.",
    icon: "🏭",
    tone: "indigo",
    actions: [
      // ===== WEB PAGE ACCESS — mirror 6 mobile pages =====
      { key: "menu.fabric_library", label: "Web · Mở Bảng vải", risk: "low", desc: "Quyền vào màn Bảng vải trên máy tính." },
      { key: "menu.design_samples", label: "Web · Mở Triển khai mẫu", risk: "low", desc: "Quyền vào màn Triển khai mẫu trên máy tính." },
      { key: "menu.measurement_library", label: "Web · Mở Bảng thông số", risk: "low", desc: "Quyền vào thư viện bảng thông số trên máy tính." },
      { key: "menu.fabric_receipts", label: "Web · Mở Vải về", risk: "low", desc: "Quyền vào màn Vải về trên máy tính." },
      { key: "menu.production", label: "Web · Mở Sản xuất", risk: "low", desc: "Quyền vào màn Lệnh sản xuất trên máy tính." },
      { key: "menu.accessories", label: "Web · Mở Nguyên phụ liệu", risk: "low", desc: "Quyền vào màn Nguyên phụ liệu trên máy tính." },

      // ===== BẢNG VẢI =====
      { key: "fabric_library.view", label: "Bảng vải · Xem", risk: "low" },
      { key: "fabric_library.create", label: "Bảng vải · Tạo bảng / NCC vải", risk: "medium" },
      { key: "fabric_library.edit", label: "Bảng vải · Sửa bảng, màu, mùa, nhóm SP", risk: "high" },
      { key: "fabric_library.upload_images", label: "Bảng vải · Upload ảnh / miếng vải", risk: "medium" },
      { key: "fabric_library.delete", label: "Bảng vải · Xoá", risk: "critical" },

      // ===== TRIỂN KHAI MẪU =====
      { key: "design_sample.view", label: "Triển khai mẫu · Xem", risk: "low" },
      { key: "design_sample.create", label: "Triển khai mẫu · Tạo mẫu", risk: "medium" },
      { key: "design_sample.edit", label: "Triển khai mẫu · Sửa mẫu / tiến độ / ảnh", risk: "high" },
      { key: "design_sample.upload_images", label: "Triển khai mẫu · Upload ảnh / file rập", risk: "medium" },
      { key: "design_sample.delete", label: "Triển khai mẫu · Xoá mẫu", risk: "critical" },
      { key: "sample_dispatch.view", label: "Triển khai mẫu · Xem lịch sử gửi mẫu", risk: "low" },
      { key: "sample_dispatch.create", label: "Triển khai mẫu · Gửi mẫu cho NCC / xưởng", risk: "medium" },
      { key: "sample_dispatch.edit", label: "Triển khai mẫu · Sửa lần gửi / tiến độ", risk: "high" },
      { key: "sample_dispatch.delete", label: "Triển khai mẫu · Xoá lần gửi", risk: "critical" },

      // ===== BẢNG THÔNG SỐ =====
      { key: "measurement_library.view", label: "Bảng thông số · Xem thư viện", risk: "low" },
      { key: "measurement_library.create", label: "Bảng thông số · Tạo bảng", risk: "medium" },
      { key: "measurement_library.edit", label: "Bảng thông số · Sửa size / dòng thông số", risk: "high" },
      { key: "measurement_library.delete", label: "Bảng thông số · Xoá bảng", risk: "critical" },

      // ===== VẢI VỀ — granular because staff will use it =====
      { key: "fabric_receipt.view", label: "Vải về · Xem danh sách / chi tiết", risk: "low" },
      { key: "fabric_receipt.create", label: "Vải về · Tạo phiếu", risk: "medium" },
      { key: "fabric_receipt.edit", label: "Vải về · Sửa phiếu / mét / kg / cây / màu / ghi chú", risk: "high" },
      { key: "fabric_receipt.measure", label: "Vải về · Cân GSM / cập nhật GSM", risk: "medium" },
      { key: "fabric_receipt.upload_images", label: "Vải về · Chụp / upload ảnh cây vải, lỗi, cân", risk: "medium" },
      {
        key: "fabric_receipt.supplier_identity.view",
        label: "Vải về · Xem đầy đủ danh tính NCC",
        risk: "high",
        desc: "Tắt quyền này: chỉ hiện mã NCC; ẩn tên, SĐT, email, địa chỉ.",
      },
      {
        key: "fabric_receipt.cost.view",
        label: "Vải về · Xem đơn giá / tiền tệ / tỷ giá",
        risk: "critical",
        desc: "Xem giá vải, CNY/VND, tỷ giá và giá quy đổi.",
      },
      {
        key: "fabric_receipt.cost.edit",
        label: "Vải về · Sửa đơn giá / tiền tệ / tỷ giá",
        risk: "critical",
        desc: "Nhập và sửa giá, loại tiền, tỷ giá quy đổi.",
      },
      { key: "fabric_receipt.approve_variance", label: "Vải về · Duyệt chênh lệch mét / kg", risk: "critical" },
      { key: "fabric_receipt.complete", label: "Vải về · Hoàn tất phiếu", risk: "high" },
      ...
      {
        key: "accessories.cost.view",
        label: "NPL · Xem đơn giá",
        risk: "critical",
        desc: "Tắt quyền này: backend và giao diện không trả/hiện đơn giá NPL.",
      },
      {
        key: "accessories.supplier_identity.view",
        label: "NPL · Xem đầy đủ danh tính NCC",
        risk: "high",
        desc: "Tắt quyền này: chỉ hiện mã NCC; ẩn tên và thông tin liên hệ.",
      },
      { key: "accessories.manage", label: "NPL · Tạo / sửa / xoá NPL & NCC", risk: "high" },
      { key: "accessories.stock", label: "NPL · Điều chỉnh tồn", risk: "high" },
    ],
  },
  {
    id: "stock_transfer",
...

  {
    ...
    actions: [
      ...
      { key: "mobile.home.production", label: "Hiện thẻ Trung tâm sản xuất", risk: "low" },

      {
        key: "mobile.production_hub.view",
        label: "Mở Trung tâm sản xuất mobile",
        risk: "low",
        desc: "Cho phép vào trang hub Sản xuất / Nguyên liệu trên app.",
      },
      { key: "mobile.page.fabric_library", label: "Mobile · Mở Bảng vải", risk: "low" },
      { key: "mobile.page.design_samples", label: "Mobile · Mở Triển khai mẫu", risk: "low" },
      { key: "mobile.page.measurement_library", label: "Mobile · Mở Bảng thông số", risk: "low" },
      { key: "mobile.page.fabric_receipts", label: "Mobile · Mở Vải về", risk: "low" },
      { key: "mobile.page.production", label: "Mobile · Mở Sản xuất", risk: "low" },
      { key: "mobile.page.accessories", label: "Mobile · Mở Nguyên phụ liệu", risk: "low" },
