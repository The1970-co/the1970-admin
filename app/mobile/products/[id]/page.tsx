...
export default function MobileProductDetailPage(){
 ...
 return <div className="min-h-screen w-full overflow-x-hidden bg-neutral-100 text-neutral-950 [text-size-adjust:100%]"><div className="mx-auto min-h-screen w-full max-w-md min-w-0 overflow-x-hidden px-4 pb-28 pt-5">
