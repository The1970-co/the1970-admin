...
export type PayrollPeriod = {
  ...
  totalHourlyAmount?: number | string | null;
  totalTaggedProductAmount?: number | string | null;
  totalMealAllowance?: number | string | null;
  totalInsuranceDeduction?: number | string | null;
  totalGhnCodBonus?: number | string | null;
...
export type PayrollLine = {
  ...
  normalHours?: number | string | null;
  ...
  convertedWorkingHours?: number | string | null;
  hourlyRate?: number | string | null;
  hourlyAmount?: number | string | null;
  paidLeaveDays?: number | string | null;
  paidLeaveHoursPerDay?: number | string | null;
  paidLeaveAmount?: number | string | null;
  mealAllowanceAmount?: number | string | null;
  insuranceDeduction?: number | string | null;
  taggedProductQty?: number | string | null;
  taggedProductRate?: number | string | null;
  taggedProductAmount?: number | string | null;
  ghnCodOrderCount?: number | string | null;
  ghnCodBonusPerOrder?: number | string | null;
  ghnCodBonusAmount?: number | string | null;
...
export type PayrollOrderLink = {
  ...
  attributionStaffName?: string | null;
  reason?: string | null;
};
